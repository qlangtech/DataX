...
//                PreparedStatement preparedStatement, IStatementSetter col, int columnIndex,
...
//                ColumnMetaData meta = this.resultSetMetaData.get(columnIndex);
//                throw new SQLException(String.format(
//                        "类型转换错误:[%s] 字段名:[%s], 字段类型:[%d], 字段Java类型:[%s].",
//                        column,
//                        meta.getName(),
//                        meta.getType().type,
//                        meta.getType().typeName));
//            }
