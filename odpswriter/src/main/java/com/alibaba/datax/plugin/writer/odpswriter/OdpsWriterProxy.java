...
public class OdpsWriterProxy {
    ...
    public long writeOneRecord(com.alibaba.datax.common.scala.element.Record dataXRecord, List<Long> blocks)
            throws Exception {
    ...
    public Record dataxRecordToOdpsRecord(com.alibaba.datax.common.scala.element.Record dataXRecord) throws Exception {
        ...
        int sourceIndex = 0;
        try {
            com.alibaba.datax.common.scala.element.Column columnValue;
...
//                    }
                    ...
                    case BINARY:
                        ...
                        break;
                    case ARRAY:
                        JSONArray arrayJson = JSONObject.parseArray(columnValue.asString());
                        ((ArrayRecord) odpsRecord).setArray(currentIndex, parseArray(arrayJson, (ArrayTypeInfo) typeInfo));
                        break;
                    case MAP:
                        JSONObject mapJson = JSONObject.parseObject(columnValue.asString());
                        ((ArrayRecord) odpsRecord).setMap(currentIndex, parseMap(mapJson, (MapTypeInfo) typeInfo));
                        break;
                    case STRUCT:
                        JSONObject structJson = JSONObject.parseObject(columnValue.asString());
