 ...
 * @create: 2021-07-12 12:05
 **/
public abstract class AbstractDFSUtil {
    ...
    public AbstractDFSUtil(org.apache.hadoop.conf.Configuration hadoopConf) {
    ...
    protected void addSourceFileByType(String filePath) {
