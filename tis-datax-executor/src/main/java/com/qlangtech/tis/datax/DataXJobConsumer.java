...
public class DataXJobConsumer extends DataXJobSingleProcessorExecutor {
    ...
    //    private static ITISCoordinator getCoordinator(String zkAddress, CuratorFramework curatorClient) throws
    //    Exception {
    ...
    //    public static DistributedQueue<CuratorDataXTaskMessage> createQueue(CuratorFramework curatorClient, String
    //    zkQueuePath
    ...
    //
    //            QueueBuilder<CuratorDataXTaskMessage> builder = QueueBuilder.builder(curatorClient, consumer, new
    //            MessageSerializer(), zkQueuePath);
    //            // .maxItems(4);
    //
