...
//        protected HashSet<String> endFiles = new HashSet<String>();//最终文件全路径
        ...
        protected HdfsHelper hdfsHelper = null;
        ...
        public void init() {
            ...
            //创建textfile存储
            this.hdfsHelper = createHdfsHelper();
        ...
        private void validateParameter() {
            ...
            if (StringUtils.isEmpty(this.path)) {
                throw new IllegalStateException("path:" + this.path + " can not be empty");
            }
            // this.path =  this.hdfsHelper this.writerSliceConfig.getNecessaryValue(Key.PATH, HdfsWriterErrorCode.REQUIRED_VALUE);
//            if (!path.startsWith("/")) {
...
//            }
        ...
        protected String getFileName() {
            if (this.fileName == null) {
                ...
                Objects.requireNonNull(cfg, "writerSliceConfig can not be null");
                this.fileName = cfg.getNecessaryValue(Key.FILE_NAME, HdfsWriterErrorCode.REQUIRED_VALUE);
            }
        ...
        @Override
        public void post() {
            hdfsHelper.renameFile(this.allFiles);
        }
